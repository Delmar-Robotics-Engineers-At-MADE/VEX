...
void usercontrol() {
  ...
  while(true) {
    ...
    basic_motor_calculation (axis1, axis3, axis4, front_left, front_right);
    normalize_motor_power (axis1, axis3, axis4, front_left, front_right);
    apply_motor_power (front_left, front_right);
